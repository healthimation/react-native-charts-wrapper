...
RCT_EXPORT_VIEW_PROPERTY(enableEnlargementOnHighlight, BOOL) \
RCT_EXPORT_VIEW_PROPERTY(makeUnhighlightedEntriesSmallerEnabled, BOOL) \
RCT_EXPORT_VIEW_PROPERTY(enableDimming, BOOL) \
